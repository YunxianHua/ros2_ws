...
namespace foxglove {
    ...
    public:
        ...
        CallbackLogger(channel_type_hint::value hint = channel_type_hint::access)
                : _staticChannels(0xffffffff), _dynamicChannels(0), _channelTypeHint(hint),
        ...
        CallbackLogger(websocketpp::log::level channels,
                ...
                : _staticChannels(channels), _dynamicChannels(0), _channelTypeHint(hint), _callback(NoOpLogCallback) {}
